...
import targetPatternContentManager from '@/composables/targetPatternContentManager'
...
export default {
    ...
    , setup() {
        ...
        const { targetPatternWrapper } = targetPatternPieceManager()
        ...
        provide('targetPatternContent', targetPatternContent)
